    ...
    <body style="background-color:WhiteSmoke">
        ...
        <div class="container text-center">
            <div class="row">
                ...
                <div class="col-md-8">
                    <h2 style="text-align:left;">Nouvel Utilisateur Information</h2>
                    <hr>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="nomdefamille" name="user_lastname" type="text"
                                    class="form-control <?php $__errorArgs = ['nomdefamille'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="adresse" name="user_adresse" class="form-control <?php $__errorArgs = ['adresse'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="role" name="role_id" type="text" class="form-select">
                                    ...
                                    <option value="4" selected>Super-User</option>
                                </select>
                            </div>
                            <div><br></div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yarenisfuentes/Desktop/git/grille-o-presto/grille-o-presto/resources/views/admin/users/create.blade.php ENDPATH**/ ?>