<?php $__env->startSection('title', 'Ajouter un Menu'); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    ...
                    <input id="semanine" name="menu_week" type="text"
                        class="form-control <?php $__errorArgs = ['menu_week'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yarenisfuentes/Desktop/git/grille-o-presto/grille-o-presto/resources/views/admin/menus/create.blade.php ENDPATH**/ ?>